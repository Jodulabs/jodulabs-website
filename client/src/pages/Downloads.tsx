    ...
    <div className="utility-page">
      ...
      <main className="downloads-main container">
        ...
        <div className="platform-list">
          <article className="platform-card platform-card-primary"><div className="platform-icon"><Monitor size={24} /></div><div className="platform-copy"><div className="platform-label"><span>Desktop</span><strong className="status-pill">Releasing soon</strong></div><h2>The main Jodu workspace.</h2><p>Compose residential plans, review the model, and work through the documents that follow from the plan. The desktop build is the first release surface for the full workflow.</p><div className="installer-placeholder-grid"><div className="installer-placeholder"><div><strong>Windows</strong><span>Installer link reserved</span></div><button className="button button-dark" disabled data-testid="windows-download-disabled"><ArrowDownToLine size={15} /> Coming soon</button></div><div className="installer-placeholder"><div><strong>macOS</strong><span>Installer link reserved</span></div><button className="button button-outline" disabled data-testid="macos-download-disabled"><ArrowDownToLine size={15} /> Coming soon</button></div></div><span className="platform-note">The official installer links will replace these placeholders when the desktop release is ready.</span></div></article>
